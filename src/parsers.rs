...
impl ClientContext {
  pub fn default_tv() -> ClientContext {
    ...
    ClientContext {
      ...
      client_name_proto: String::from("7"),
      os_name: String::from(""),
  ...
  pub fn default_android() -> ClientContext {
    ClientContext {
      ...
      user_agent: format!("com.google.android.youtube/{} (Linux; U; Android 12; US) gzip", DEFAULT_ANDROID_CVER),
      client_name: String::from("ANDROID"),
      client_name_proto: String::from("3"),
